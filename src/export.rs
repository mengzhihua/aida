...
pub fn to_html(snap: &HardwareSnapshot) -> String {
    ...
    html.push_str(&format!(
        "<p class=\"muted\">thin_linear {} limit_out {} comp_sack {} fwd_prio {} fib_notify {} echo_probe {} fwmark {} ndisc_notify {}</p>",
    ...
    kv(
        ...
        &[
            ...
            (
                "nmi/watchdog",
                format!(
                    "nmi {} wd {} thresh {} unknown_nmi_panic {} panic {} sysrq {} min_free {} hung {} core_pipe {} printk_devkmsg {} delayacct {} acct {} mount_max {} rng_wake {} urandom_reseed {} soft_wd {} wd_mask {} rcu_stall {} warn {} kexec_limit {} split_lock {} hung_warn {} hung_check {} hung_interval {} kexec_reboot {} rcu_stall_max {} panic_print {} io_nmi {} hung_bt {} unrecovered_nmi {} oops_bt {}",
            ...
            (
                "vm",
                format!(
                    "swappiness {} overcommit {} overcommit_kbytes {} dirty_bytes {}/{} watermark {} boost {} pipe_pages {}/{} compact_unevict {} zone_reclaim {} dirty_expire {} dirtytime {} memfd_noexec {} compact_proact {} page_lock {}",
