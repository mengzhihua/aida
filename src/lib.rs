...
//!
//! - [`access`] 权限与读取原语
//! - [`probes`] CPU / DMI / GPU / virtio / KVM / IOMMU / 网络 / USB / 输入 / NUMA / 内存 / zram/zswap / 电源 / 睡眠 / RAPL / 声卡 / 固件 / 文件系统 / 模块 / 时钟 / EDAC / iomem / PSI / IRQ / ATA / MD / SCSI / iSCSI / 平台 / 总线 / cgroup / sysctl / 安全 / crypto / 命名空间 / hwmon / NVMe / PCI / 块设备 / 软件
//! - [`snapshot`] 一次完整快照
//! - [`export`] JSON/HTML
